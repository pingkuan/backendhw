...
Use make run command to run mongodb container and server

Use viper to read server.env file for mongouri、channel_secret and channel_access_token
![Alt](https://drive.google.com/uc?export=view&id=1oe-7KtUG8R5gC57AZxYMQKKW44aT1QiR)

## Save message to database

![Alt](https://drive.google.com/uc?export=view&id=1JSI1PR1Ud1xpwyxZwpK7Ex9buYoIBbVr)
